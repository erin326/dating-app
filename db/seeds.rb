...
tiffany.user_image.attach(io: File.open(Rails.root.join('images/anna.jpg')),
            filename: 'anna.jpg')
...
anna.user_image.attach(io: File.open(Rails.root.join('images/anna.jpg')),
                  filename: 'anna.jpg')
...
violet.user_image.attach(io: File.open(Rails.root.join('images/violet.jpg')),
                  filename: 'violet.jpg')
...
theresa.user_image.attach(io: File.open(Rails.root.join('images/theresa.jpg')),
...
nikki.user_image.attach(io: File.open(Rails.root.join('images/nikki.jpg')),
                  filename: 'nikki.jpg')                                   
...
kelly.user_image.attach(io: File.open(Rails.root.join('images/kelly.jpg')),
                  filename: 'kelly.jpg')
...
liz.user_image.attach(io: File.open(Rails.root.join('images/liz.jpg')),
                  filename: 'liz.jpg')
