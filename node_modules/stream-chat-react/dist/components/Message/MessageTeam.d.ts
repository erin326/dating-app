 ...
 */
export declare const MessageTeam: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: Partial<MessageContextValue<StreamChatGenerics>>) => JSX.Element;
