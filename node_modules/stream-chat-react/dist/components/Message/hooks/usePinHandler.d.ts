...
export declare const usePinHandler: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(message: StreamMessage<StreamChatGenerics>, permissions?: PinPermissions, notifications?: PinMessageNotifications<StreamChatGenerics>) => {
    canPin: boolean;
